...
const SAMPLE_CHANNELS: Channel[] = [
  ...
  },
  {
    ...
    tvgLogo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Elephants_Dream_s1_proog.jpg/220px-Elephants_Dream_s1_proog.jpg",
    groupTitle: "Demo",
    url: "https://test-streams.mux.dev/elephants_dream/playlist.m3u8",
    duration: -1,
    extras: {},
  },
  {
