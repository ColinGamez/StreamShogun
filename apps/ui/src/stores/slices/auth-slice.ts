...
export const createAuthSlice: StateCreator<AppState, [], [], AuthSlice> = (set, get) => ({
  authUser: loadJson<{ id: string; email: string; displayName?: string; createdAt: string } | null>(
    P,
    "shogun:auth-user",
    null,
  ),
  ...
  requestFeature: (flagKey) => {
    ...
    window.dispatchEvent(new CustomEvent("shogun:show-paywall", { detail: { feature: flagKey } }));
    return false;
  },
});
