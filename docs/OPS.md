...
2. Click "Reveal" on the signing secret. Note the CURRENT <Stripe webhook secret> value.

3. Click "Roll secret" — Stripe gives you a NEW <Stripe webhook secret> value.
